...
function diginu_leaderboard_shortcode($atts) {
  ...
  if (empty($atts['src'])) {
    return '<em>https://docs.google.com/spreadsheets/d/e/2PACX-1vRgL9D3f8unpiKtGBbmQvtqCLg-ZoxSl5epX76sMRaWPng46PcShZHRVx7zxVoeSI2JGiY_-EyPQK12/pub?gid=0&single=true&output=csv</em>';
  }
